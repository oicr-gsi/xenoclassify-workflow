 ...
 * @author prath
 */
public class XenoClassifyWorkflowTest {

    public XenoClassifyWorkflowTest() {
    }
    ...
    public void validateRegressionTestDefinition() throws IllegalAccessException, InstantiationException, IOException, Exception {
        ...
        for (TestDefinition.Test t : td.getTests()) {
            DryRun d = new DryRun(System.getProperty("bundleDirectory"), t.getParameters(), XenoClassifyWorkflow.class);
